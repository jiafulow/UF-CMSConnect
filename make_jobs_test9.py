...
input_files = [
  'emtf_ristretto.py', 'emtf_algos.py', 'emtf_utils.py', 'emtf_ntuples.py',
]
...
jobs.create(tag='test1', algo='default', analysis='signal', jobids=range(100), commands=commands)
jobs.create(tag='test2', algo='default', analysis='signal_displ', jobids=range(200), commands=commands)
jobs.create(tag='test3', algo='default', analysis='bkgnd', jobids=range(192), commands=commands)
